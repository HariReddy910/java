...
public enum Config implements PeConfig {
  ...
  private final static String SERVICE_ID = "pe/com.harindra";

  Config() {
    config = SpConfig.getSpConfig(SERVICE_ID);

    config.register(ConfigKeys.HOST, "app_v11.0", "Hostname for the pe source component");
    ...
    config.register(ConfigKeys.SERVICE_NAME, "example", "The name of the service");
